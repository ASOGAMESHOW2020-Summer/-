...
public class GameSystem : MonoBehaviour
{
    ...
    * ------------*/
    ...
    public GameObject itemButton_katana;
    ...
    public void searchTreasureBox()
    {
        ...
        if(Physics.Raycast(ray,out hit,10000000,1<<8))
        {
            ...
            switch(selectedGameObject.name)
            {
                ...
                case "katana":
                    ...
                    itemButton_katana.SetActive(true);
                    break;
                case "tabi":
        ...
        if(Physics.Raycast(rayItem,out hit,10000000,1<<9))
        {
            ...
            switch(selectedGameObject.name)
            {
                ...
                case "itemButton_katana_plane":
                    if(myItem=="katana")
                    {
                        selectedGameObject.Find("itemButton_katana_plane").GetComponent<Renderer>();
                        myItem = "noitem";
        
                    }
                    else
                    {
                        GameObject.Find("itemButton_katana_plane").GetComponent<Renderer>();
                        myItem = "katana";
                    }
                    break;

                case "itemButton_sensu_plane":
                    if(myItem=="sensu")
                    {
                        selectedGameObject.Find("itemButton_sensu_plane").GetComponent<Renderer>();
                        myItem = "noitem";
                    }
                    else
                    {
                        GameObject.Find("itemButton_sensu_plane").GetComponent<Renderer>();
                        myItem = "sensu";
                    }
                    break;

                case "itemButton_tabi_plane":
                    if (myItem == "tabi")
                    {
                        selectedGameObject.Find("itemButton_tabi_plane").GetComponent<Renderer>();
                        myItem = "noitem";
                    }
                    else
                    {
                        GameObject.Find("itemButton_tabi_plane").GetComponent<Renderer>();
                        myItem = "tabi";
                    }
                    break;

                case "itemButton_juzu_plane":
                    if (myItem == "juzu")
                    {
                        selectedGameObject.Find("itemButton_juzu_plane").GetComponent<Renderer>();
                        myItem = "noitem";
                    }
                    else
                    {
                        GameObject.Find("itemButton_juzu_plane").GetComponent<Renderer>();
                        myItem = "juzu";
                    }
                    break;
            }
